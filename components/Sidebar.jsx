...
const Sidebar = ({ children }) => {
  ...
  return (
    <>
              ...
              <div className="flex items-center ml-3">
                <div>
                  ...
                  >
                    ...
                    <BsPersonCircle size={32} className="fill-gray-600" />
                  </button>
                </div>
                <div
                  className={`z-50 absolute top-10 right-2 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 ${
                    !profile ? "hidden" : null
                  }`}
                  id="dropdown-user"
                >
      ...
      <main className="p-4 pt-5 sm:ml-64 bg-gray-50 w-full mt-16">
        {children}
      </main>
    </>
  );
